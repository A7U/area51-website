...
DB_CONTAINER_NAME="area51-website-mysql"
...
docker run --name $DB_CONTAINER_NAME -e MYSQL_ROOT_PASSWORD=$DB_PASSWORD -e MYSQL_DATABASE=area51-website -d -p 3306:3306 docker.io/mysql
